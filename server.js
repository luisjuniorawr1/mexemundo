...
const server = http.createServer((req, res) => {
  ...
  if (requestUrl.pathname === '/health') {
    ...
    res.end(JSON.stringify({
      ...
      handSystem: 'universal-two-hand-v1.5.3',
      ...
      palmPresence: 'wrist-or-two-pose-finger-points',
      ...
      identity: 'continuous-two-hand-v1-anatomical-single-side',
      singleHandAssignment: 'preserve-pose-anatomical-side-no-nearest-track-steal',
