...
const server = http.createServer((req, res) => {
  ...
  if (requestUrl.pathname === '/health') {
    ...
    res.end(JSON.stringify({
      ...
      handSystem: 'universal-two-hand-v1.3',
      handInput: 'mexeflow-visual-and-fast-collision',
      gamePostProcessing: 'none',
      menu: 'fist-click-with-target-latch',
      ...
      visualResponse: 'mexeflow-v1-rest-hysteresis-adaptive-response',
      gesture: 'pose-fist-bootstrap-two-tip-target-latch',
